execute if entity @s[y_rotation=-135.1..-45] run summon minecraft:wandering_trader ^ ^ ^ {Silent:1b,NoAI:0b,Invulnerable:1b,Rotation:[90f,0f],wander_target:[I;0,0,0],Tags:["exp.mech","exp.new_vehicle","exp.vehicle","exp.mob","exp.mech_mob","exp.moddable_vehicle","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"expansion:empty"}}],Passengers:[{id:"minecraft:armor_stand",Marker:1b,Tags:["exp.AI_resetter"],Passengers:[{id:"minecraft:cat",Tags:["exp.mech_seat"],NoAI:1b,Silent:1b,Invulnerable:1b,active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}]}]},{id:"minecraft:interaction",Tags:["exp.mech_rcdet","exp.hitbox","smithed.block"],width:2,height:2f,response:0b}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:1,show_particles:0b}]}
execute if entity @s[y_rotation=45.1..135] run summon minecraft:wandering_trader ^ ^ ^ {Silent:1b,NoAI:0b,Invulnerable:1b,Rotation:[270f,0f],wander_target:[I;0,0,0],Tags:["exp.mech","exp.new_vehicle","exp.vehicle","exp.mob","exp.mech_mob","exp.moddable_vehicle","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"expansion:empty"}}],Passengers:[{id:"minecraft:armor_stand",Marker:1b,Tags:["exp.AI_resetter"],Passengers:[{id:"minecraft:cat",Tags:["exp.mech_seat"],NoAI:1b,Silent:1b,Invulnerable:1b,active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}]}]},{id:"minecraft:interaction",Tags:["exp.mech_rcdet","exp.hitbox","smithed.block"],width:2,height:2f,response:0b}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:1,show_particles:0b}]}
execute if entity @s[y_rotation=-45..45] run summon minecraft:wandering_trader ^ ^ ^ {Silent:1b,NoAI:0b,Invulnerable:1b,Rotation:[180f,0f],wander_target:[I;0,0,0],Tags:["exp.mech","exp.new_vehicle","exp.vehicle","exp.mob","exp.mech_mob","exp.moddable_vehicle","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"expansion:empty"}}],Passengers:[{id:"minecraft:armor_stand",Marker:1b,Tags:["exp.AI_resetter"],Passengers:[{id:"minecraft:cat",Tags:["exp.mech_seat"],NoAI:1b,Silent:1b,Invulnerable:1b,active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}]}]},{id:"minecraft:interaction",Tags:["exp.mech_rcdet","exp.hitbox","smithed.block"],width:2,height:2f,response:0b}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:1,show_particles:0b}]}
execute if entity @s[y_rotation=135.1..-135] run summon minecraft:wandering_trader ^ ^ ^ {Silent:1b,NoAI:0b,Invulnerable:1b,Rotation:[0f,0f],wander_target:[I;0,0,0],Tags:["exp.mech","exp.new_vehicle","exp.vehicle","exp.mob","exp.mech_mob","exp.moddable_vehicle","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"expansion:empty"}}],Passengers:[{id:"minecraft:armor_stand",Marker:1b,Tags:["exp.AI_resetter"],Passengers:[{id:"minecraft:cat",Tags:["exp.mech_seat"],NoAI:1b,Silent:1b,Invulnerable:1b,active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}]}]},{id:"minecraft:interaction",Tags:["exp.mech_rcdet","exp.hitbox","smithed.block"],width:2,height:2f,response:0b}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:1,show_particles:0b}]}

# summon the animated java rigs
execute positioned ~ ~1.48 ~ rotated as @e[type=wandering_trader,tag=exp.mech,limit=1,sort=nearest] run function animated_java:mech_legs/summon {args: {}}
execute positioned ~ ~1.48 ~ rotated as @e[type=wandering_trader,tag=exp.mech,limit=1,sort=nearest] run function animated_java:mech_torso/summon {args: {}}
