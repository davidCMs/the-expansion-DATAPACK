summon armor_stand ~ ~ ~ {Silent:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["exp.evil_drone","exp.ranged_drone","exp.mob"],Passengers:[{id:"minecraft:vex",Silent:1b,DeathLootTable:"expansion:empty",HandItems:[{},{}],NoAI:1b,AbsorptionAmount:20f,Health:20f,Tags:["exp.evil_drone_hitbox"],active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:-1,show_particles:0b}],attributes:[{id:"minecraft:max_health",base:20}]}],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:item_model":"expansion:mobs/evil_drone"}}],CustomName:'"Emergency Drone"'}
