...
execute if items entity @s player.cursor *[minecraft:custom_data~{exp_armor.equipped:1b}] run item modify entity @s player.cursor {"function": "minecraft:set_custom_data",tag:{exp_armor.equipped:0b}}
