...
execute if entity @s[tag=exp.drone_laser] run function expansion:mobs/evil_drone/ranged_drone/laser

execute if entity @s[tag=exp.homing_rocket] run function expansion:vehicles/mech/actions/righthand/rocket/loop
