...
execute if items entity @s container.0 *[custom_data~{expansion_coas:1b}] run data merge entity @s {transformation:{translation:[0.0,0.3,0.0],scale:[0.45,0.45,0.45]},interpolation_duration:50,start_interpolation:-1}
...
# 
rotate @s ~ 90
execute if items entity @s container.0 *[custom_data~{expansion_coas:1b}] run return run rotate @s ~ 0
