...
# summon the model
execute if entity @s[y_rotation=-135.1..-45] positioned ~ ~1.975 ~ rotated 90 0 run function animated_java:fabricator/summon {args: {}}
execute if entity @s[y_rotation=45.1..135] positioned ~ ~1.975 ~ rotated 270 0 run function animated_java:fabricator/summon {args: {}}
execute if entity @s[y_rotation=-45..45] positioned ~ ~1.975 ~ rotated 180 0 run function animated_java:fabricator/summon {args: {}}
execute if entity @s[y_rotation=135.1..-135] positioned ~ ~1.975 ~ rotated 0 0 run function animated_java:fabricator/summon {args: {}}
