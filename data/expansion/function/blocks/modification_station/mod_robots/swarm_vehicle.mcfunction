...
execute on passengers on origin facing entity @s eyes as @n[type=item_display,tag=exp.current_drone,distance=..0.01] positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^10 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.4 ~ ~
