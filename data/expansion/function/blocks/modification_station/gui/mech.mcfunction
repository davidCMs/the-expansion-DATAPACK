...
execute unless items block ~ ~ ~ container.3 *[custom_data~{gui_item:1b}] run function expansion:utilities/barrel/gui/fill_slot {Slot:3, Type:"modstation_mech"}
...
execute if items block ~ ~ ~ container.14 jigsaw[minecraft:custom_data~{gui_item:1b}] run item replace block ~ ~ ~ container.14 with air
...
execute if items block ~ ~ ~ container.23 jigsaw[minecraft:custom_data~{gui_item:1b}] run item replace block ~ ~ ~ container.23 with air
