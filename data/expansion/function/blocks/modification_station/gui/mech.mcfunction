...
execute unless items block ~ ~ ~ container.3 * run loot replace block ~ ~ ~ container.3 loot expansion:items/gui/modstation_mech
...
execute unless items block ~ ~ ~ container.8 * run loot replace block ~ ~ ~ container.8 loot expansion:items/gui/tips/modstation_mech
...
execute unless items block ~ ~ ~ container.16 * run loot replace block ~ ~ ~ container.16 loot expansion:items/gui/filler
execute unless items block ~ ~ ~ container.17 * run loot replace block ~ ~ ~ container.17 loot expansion:items/gui/icons/upgrade
...
execute unless items block ~ ~ ~ container.26 * run loot replace block ~ ~ ~ container.26 loot expansion:items/gui/icons/remove