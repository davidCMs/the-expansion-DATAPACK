...
execute positioned ~ ~1 ~ run function expansion:blocks/oxygenator/oxygenate/fill_space/check_new_pos
execute positioned ~ ~-1 ~ run function expansion:blocks/oxygenator/oxygenate/fill_space/check_new_pos
execute positioned ~1 ~ ~ run function expansion:blocks/oxygenator/oxygenate/fill_space/check_new_pos
execute positioned ~-1 ~ ~ run function expansion:blocks/oxygenator/oxygenate/fill_space/check_new_pos
execute positioned ~ ~ ~1 run function expansion:blocks/oxygenator/oxygenate/fill_space/check_new_pos
...
tag @n[type=minecraft:marker,distance=..0.001] add exp.scanned
