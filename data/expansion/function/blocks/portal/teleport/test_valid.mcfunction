...
execute unless score portal.dim exp.value matches -1 unless score portal.match exp.value matches 0 if score portal.x1.pos exp.value = portal.x2.pos exp.value if score portal.y1.pos exp.value = portal.y2.pos exp.value if score portal.z1.pos exp.value = portal.z2.pos exp.value run scoreboard players set #temp exp.bool 1