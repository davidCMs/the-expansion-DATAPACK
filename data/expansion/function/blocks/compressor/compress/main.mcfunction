...
execute if score #temp exp.timer_1 matches 0 if predicate expansion:dimension/oxygen_absent if entity @s[tag=exp.inside_habitable_space] run function expansion:blocks/compressor/compress/insert_check
