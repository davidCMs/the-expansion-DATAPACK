...
execute unless items block ~ ~ ~ container.5 *[custom_data~{enhancer_none:1b}] run function expansion:utilities/barrel/gui/fill_slot {Slot:5, Type:"enhancer_none"}
...
execute unless items block ~ ~ ~ container.16 *[custom_data~{gui_item:1b}] run function expansion:utilities/barrel/gui/fill_slot {Slot:16, Type:"filler_visible"}
