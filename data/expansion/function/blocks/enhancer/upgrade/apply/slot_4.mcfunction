...
execute if items block ~ ~ ~ container.15 *[minecraft:custom_data~{exp_item:{name:"slot_module"}}] run return run execute unless score #copy_module exp.max_range matches 5.. run function expansion:blocks/enhancer/upgrade/apply/effects/add_slot
