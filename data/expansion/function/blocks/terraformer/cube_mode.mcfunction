...
execute if predicate expansion:periodic/10 at @s positioned ~-24 ~-24 ~-24 as @n[type=#expansion:wants_oxygen,tag=!exp.inside_habitable_space,tag=!exp.terraformer.ignore,dx=47,dy=47,dz=47] positioned ~24 ~24 ~24 run function expansion:blocks/terraformer/grant_oxygen
