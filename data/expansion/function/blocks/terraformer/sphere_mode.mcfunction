...
execute if predicate expansion:periodic/10 at @s as @e[type=#expansion:wants_oxygen,tag=!exp.inside_habitable_space,tag=!exp.terraformer.ignore,distance=0.5..40,limit=1] run function expansion:blocks/terraformer/grant_oxygen
