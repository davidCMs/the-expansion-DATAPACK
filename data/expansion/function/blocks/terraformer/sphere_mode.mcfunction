...
execute if predicate expansion:periodic/10 at @s as @n[type=#expansion:wants_oxygen,tag=!exp.has_oxygen,tag=!exp.terraformer.ignore,distance=0.5..40] run function expansion:blocks/terraformer/grant_oxygen
