...
execute if entity @s[tag=!exp.summoned_new_module,tag=exp.rocket_pilot] at @s if loaded ~ ~ ~ run function expansion:vehicles/lunar_module/summon/from_transition
