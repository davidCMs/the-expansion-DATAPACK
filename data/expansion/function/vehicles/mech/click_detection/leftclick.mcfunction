# lefthand actions
execute if predicate expansion:nbt_checks/root_vehicle/mech on vehicle on vehicle on passengers if entity @s[tag=exp.left_arm_control] run function expansion:vehicles/mech/actions/input
