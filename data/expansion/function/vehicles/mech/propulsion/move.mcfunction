...
execute if predicate expansion:input/backward run scoreboard players operation #sin_tet exp.math *= #-1 exp.const
...
execute if predicate expansion:input/backward run scoreboard players operation #cos_tet exp.math *= #-1 exp.const
