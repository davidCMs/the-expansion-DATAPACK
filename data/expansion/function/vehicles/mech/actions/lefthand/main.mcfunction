...
execute if score @s[tag=exp.mech_walking_forwards] exp.mech_left_dur matches 1 on passengers if entity @s[type=minecraft:item_display,tag=aj.mech_torso.root] run function animated_java:mech_torso/animations/walking_left/stop
execute if score @s[tag=exp.mech_walking_backwards] exp.mech_left_dur matches 1 on passengers if entity @s[type=minecraft:item_display,tag=aj.mech_torso.root] run function animated_java:mech_torso/animations/walking_backwards_left/stop
