...
execute positioned ^.5 ^4 ^1 if block ~ ~ ~ #expansion:drillable run setblock ~ ~ ~ air destroy
...
execute positioned ^1.5 ^4 ^1 if block ~ ~ ~ #expansion:drillable run setblock ~ ~ ~ air destroy
...
execute positioned ^.5 ^4 ^ if block ~ ~ ~ #expansion:drillable run setblock ~ ~ ~ air destroy
...
execute positioned ^1.5 ^4 ^ if block ~ ~ ~ #expansion:drillable run setblock ~ ~ ~ air destroy
