...
data merge entity @s {item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"expansion:missile"}},teleport_duration:1,transformation:{scale:[1.0f,1.0f,1.0f],translation:[0.0f,0.5f,0.0f]}}
