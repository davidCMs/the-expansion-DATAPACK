execute rotated as @e[type=minecraft:item_display,tag=aj.mech_torso.root,limit=1,sort=nearest] run rotate @s ~ ~
...
execute on vehicle on vehicle run data merge entity @s {NoAI:0b}
