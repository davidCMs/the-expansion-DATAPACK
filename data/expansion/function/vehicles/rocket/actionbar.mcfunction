...
data merge storage expansion:temp {actionbar:{position:[[{text:"◀",color:"white"},{score:{name:"@s",objective:"exp.x"}},{text:", "}],[{text:"",color:"white"},{score:{name:"@s",objective:"exp.y"}},{text:", "}],[{text:"",color:"white"},{score:{name:"@s",objective:"exp.z"}},{text:"▶"}]],fuel:[{text:"◀",color:"green"},{score:{name:"@s",objective:"exp.fuel_percentage"}},{text:"%▶"}]}}
