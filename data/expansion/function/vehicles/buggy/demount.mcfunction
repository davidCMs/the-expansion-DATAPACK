execute store result entity @s ArmorItems[0].components."minecraft:custom_data".ModStorage.oxygen_tank.components."minecraft:custom_data".oxygen.lvl int 1 run scoreboard players get @s exp.oxygen_lvl
