...
execute on passengers if entity @s[type=player] if predicate expansion:input/backward unless predicate expansion:input/forward on vehicle if score @s exp.speed matches 11..50 run scoreboard players remove @s exp.speed 2
execute on passengers if entity @s[type=player] if predicate expansion:input/backward unless predicate expansion:input/forward on vehicle if score @s exp.speed matches -49..10 run scoreboard players remove @s exp.speed 1
