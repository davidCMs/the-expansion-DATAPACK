...
data merge storage expansion:temp {actionbar:{position:[[{text:"◀",color:"green"},{score:{name:"@s",objective:"exp.x"}},{text:"%▶"}],[{text:"◀",color:"green"},{score:{name:"@s",objective:"exp.y"}},{text:"%▶"}],[{text:"◀",color:"green"},{score:{name:"@s",objective:"exp.z"}},{text:"%▶"}]],speed:[{text:"◀",color:"green"},{score:{name:"@s",objective:"exp.speed"}},{text:"%▶"}],fuel:[{text:"◀",color:"green"},{score:{name:"@s",objective:"exp.fuel_percentage"}},{text:"%▶"}]}}
