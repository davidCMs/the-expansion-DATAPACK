...
execute at @s if predicate expansion:nbt_checks/root_vehicle/spaceship if predicate expansion:dimension/space if entity @s[tag=exp.spaceship_pilot] on vehicle on vehicle run function expansion:vehicles/spaceship/markers/marker_switcher
