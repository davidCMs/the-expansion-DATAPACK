...
execute on passengers if data entity @s[type=minecraft:armor_stand,tag=exp.spaceship_display] ArmorItems[3].components."minecraft:custom_data".ModStorage.fuel.components."minecraft:custom_data".value on vehicle store result score @s exp.value on passengers if entity @s[type=armor_stand] run data get entity @s[type=minecraft:armor_stand,tag=exp.spaceship_display] ArmorItems[3].components."minecraft:custom_data".ModStorage.fuel.components."minecraft:custom_data".value
scoreboard players set @s exp.speed_mod 10
execute on passengers if data entity @s[type=minecraft:armor_stand,tag=exp.spaceship_display] ArmorItems[3].components."minecraft:custom_data".ModStorage.speed.components."minecraft:custom_data".value on vehicle store result score @s exp.delay on passengers if entity @s[type=armor_stand] run data get entity @s[type=minecraft:armor_stand,tag=exp.spaceship_display] ArmorItems[3].components."minecraft:custom_data".ModStorage.speed.components."minecraft:custom_data".speed_mod
scoreboard players set @s exp.unique_id 0
execute on passengers if data entity @s[type=minecraft:armor_stand,tag=exp.spaceship_display] ArmorItems[3].components."minecraft:custom_data".ModStorage.blaster.components."minecraft:custom_data".id on vehicle store result score @s exp.unique_id on passengers if entity @s[type=armor_stand] run data get entity @s[type=minecraft:armor_stand,tag=exp.spaceship_display] ArmorItems[3].components."minecraft:custom_data".ModStorage.blaster.components."minecraft:custom_data".id
