...
execute if data storage expansion:temp ModStorage[0].components.minecraft:custom_data.oxygen_tank run function expansion:items/space_equipment/insert_oxygen_values
...
execute if score #temp exp.max_range matches 1.. run return run function expansion:items/space_equipment/find_oxygen_lvl