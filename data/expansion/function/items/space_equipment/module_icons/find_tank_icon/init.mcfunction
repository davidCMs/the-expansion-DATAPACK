...
execute if score #tier exp.math matches 1 run function expansion:items/space_equipment/module_icons/find_tank_icon/tier1
execute if score #tier exp.math matches 2 run function expansion:items/space_equipment/module_icons/find_tank_icon/tier2
execute if score #tier exp.math matches 3 run function expansion:items/space_equipment/module_icons/find_tank_icon/tier3
