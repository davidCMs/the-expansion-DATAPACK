...
execute unless entity @s[type=item_display,tag=aj.mech_legs.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'mech_legs', 'function_path': 'animated_java:mech_legs/animations/pause_all'}
